...
export interface DataAccessInterface {
    isV4(): boolean;
    getNavigationPropertyKeys(data: any, navPropDetail: any, currentEntityType: EntityType, currentEntitySet: EntitySet | undefined, currentKeys: KeyDefinitions, tenantId: string, forCreate?: boolean): Promise<KeyDefinitions>;
...
export declare function getData(fullData: any, objectPath: string): any;
